...
public class ComponentDataProvider {
    ...
    public static Object[][] getComponentWithExpression(Method method) {
        ...
        Component paragraphExpression = getCompositeComponent(Arrays.asList(sentenceExpression, sentenceExpression, sentenceExpression, sentenceExpression, sentenceExpression, sentenceExpression,
                sentenceExpression));
